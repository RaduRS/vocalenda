...
export const metadata: Metadata = {
  title: "Sign Up - Vocalenda",
  description:
    "Create your Vocalenda account and start automating your bookings with AI voice agents.",
  robots: {
    index: true,
    follow: true,
  },
...
export default function SignUpPage() {
  return (
    <div className="min-h-screen flex overflow-hidden">
      ...
      <div className="lg:hidden min-h-screen w-full bg-gradient-to-br from-[#6c47ff] via-[#8b7aff] to-[#a855f7] relative flex items-center justify-center p-4 flex-col">
        ...
        {/* Terms and Privacy - Fixed position */}
        <div className="pt-4">
          <p className="text-xs text-zinc-800/80 text-center">
            By signing up, you agree to our{" "}
            <a
              href="/terms"
              className="text-zinc-800 hover:text-blue-600 underline"
            >
              Terms of Service
            </a>{" "}
            and{" "}
      ...
      <div className="hidden lg:flex w-full h-screen">
        {/* Left Side - Modal */}
        <div className="w-1/2 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 flex flex-col items-center justify-center p-8 lg:p-12">
